      ...
      if (arguments.length > 2) {
        ...
        defer = defer.then(() => {
            if (client) {
              ...
              return transport.doCall.apply(this, [this._id, client.client].concat(Array.apply(this, arguments)));
            }
      ...
      .map((data) => {
        ...
        try {
          ...
          if (data && data.host && data.port) {
            ...
            // set id
            // get processor
            let processor = this._thrifts[alias] ? this._thrifts[alias] : Processor;
            // new
